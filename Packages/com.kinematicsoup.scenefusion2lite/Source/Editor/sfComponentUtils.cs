...
namespace KS.SceneFusion2.Unity.Editor
{
    ...
    public class sfComponentUtils
    {
         ...
         * 
         * @param   GameObject child to set parent for.
         * @param   GameObject parent to set. Null to make the child a root object.
         */
         ...
         * corrupting the hierarchy.
         * 
         * @param   Transform child to set parent for.
         * @param   Transform parent to set. Null to make the child a root object.
         */
